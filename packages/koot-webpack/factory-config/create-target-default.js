 ...
 * @param {Object} [kootConfig={}] Koot 配置对象
 * @returns {Object} 根据当前环境的配置对象
 */
module.exports = async (options = {}, configFilePathname, kootConfig = {}) => {
    const {
    ...
    configFilePathname =
        configFilePathname ||
        path.resolve(__dirname, `_defaults/${TYPE}.${STAGE}.${ENV}.js`);
    ...
    return await factory(options, kootConfig);
};
