module.exports = {
    ...
    "welcome_exist_current_super_project": "Koot CLI tool need [koot] to run while this project is using [super-project]. Do you want to upgrade to [koot]?",

    "koot-cli_updated": "koot-cli has updated",
    "koot-cli_updated_description": "Recommended to upgrade koot-cli to latest version. Use following command to upgrade:",
    ...
    "upgrade_error:super-project version invalid": "[super-project] version number invalid",
    "upgrade_error:super-project version too low": "[super-project] is too out-dated. Please update to [koot] manually",
    "upgrading": "Upgrading",
