...
module.exports = async (dir = process.cwd()) => {
    ...
    const waiting = spinner(chalk.whiteBright(_('upgrade_determining')) + '...')
    ...
    // }
    if (semver.lt(versionKootLocal, semver.valid(semver.coerce(latestPackageJson.version))))
