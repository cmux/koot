...
const create = async (settings = {}, i18n, bundleVersionsKeep) => {
    ...
    if (isI18nDefault && Array.isArray(i18n.locales)) {
        for (let arr of i18n.locales) {
            ...
            console.log(`\x1b[32m√\x1b[0m \x1b[93m[koot/build]\x1b[0m PWA: \x1b[32m${pathnameSW}\x1b[0m created`)
        }
    } else {
        await createSW({
        ...
        console.log(`\x1b[32m√\x1b[0m \x1b[93m[koot/build]\x1b[0m PWA: \x1b[32m${pathname}\x1b[0m created`)
    }
